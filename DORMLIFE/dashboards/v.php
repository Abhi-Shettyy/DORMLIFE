...
<body>
    ...
    <div class="content">
        ...
        <div id="about-section" class="about-section">
            <h3>About V Block</h3>
            <p>
                V Block Hostel is renowned for its spacious rooms and excellent amenities. Whether you are studying or
                relaxing, V Block ensures a productive and comfortable stay.
            </p>
        </div>
