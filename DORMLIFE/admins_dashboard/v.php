...
<head>
    ...
    <style>
        body {
            ...
            background-color:rgb(241, 241, 205);
            margin: 0;
            padding: 0;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-content">
            ...
            <a href="view_room_booking.php" class="btn">View Bookings</a>
                ...
                <tbody>
                    <?php while ($row = $search_results->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="../admins/edit_studentv.php?id=<?php echo $row['StudentID']; ?>" class="btn">Edit</a>
                                <a href="../admins/delete_studentv.php?id=<?php echo $row['StudentID']; ?>" class="btn"
